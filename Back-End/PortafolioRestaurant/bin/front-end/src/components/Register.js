...
const Register = () => {
  ...
  function crearUsuario(){
    ...
    .then((usuario) => {
      window.location.href = `/usurios/${usuario.id}`;
    })
  }
    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        <div className="flex flex-col items-center justify-center bg-gray-100 rounded-tl-lg rounded-bl-lg p-4">
          <div className="my-8">
            <h1 className="text-4xl font-bold text-gray-900">Restaurant Siglo XXl</h1>
          </div>
        ...
        <div className="hidden lg:flex items-center justify-center border-t border-r border-b rounded-tr-lg rounded-br-lg">
          <img
            src="https://www.clara.es/medio/2021/12/16/que-comer-hoy-dorada-a-la-plancha-con-arroz_db0693b5_1280x1820.jpg"
